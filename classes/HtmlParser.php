...
class HtmlParser {
	private static $html = array(
		...
		'#\<ins\>(.*?)\</ins\>#si',
		'#\<del\>(.*?)\</del\>#si',
		'#\<p class\=\"wysrodkowanie\"\>(.*?)\</p\>#si',
		'#\<p class\=\"do_prawej\"\>(.*?)\</p\>#si',
		'#\<p class\=\"akapit\"\>(.*?)\</p\>#si',
		'#\<p class\=\"akapit\"\ style\=\"text-indent\: (.*?)px\"\>(.*?)\</p\>#si',
		'#\<img src\=\"(.*?)\"\>#si',
		'#\<a href\=\"(http.*?)\"\>(http\/\/.*?)\</a\>#si', // link z http bez podpisu 
		'#\<a href\=\"(http.*?)\"\>(.*?)\</a\>#si', // link z podpisem z http
	...
	private static $bbcode = array(
		...
		'[size=\\1]\\2[/size]',
		'[jutsu]\\1[/jutsu]', // jutsu
		'[jutsu=katon]\\1[/jutsu]', // jutsu ognia
		'[jutsu=doton]\\1[/jutsu]', // jutsu ziemi
		'[jutsu=futon]\\1[/jutsu]', // jutsu wiatru
		'[jutsu=suiton]\\1[/jutsu]', // jutsu wody
		'[jutsu=raiton]\\1[/jutsu]', // jutsu błyskawicy
		'[list]\\1[/list]',
		'[listo]\\1[/listo]',
		'[li]\\1[/li]',
		'[youtube]\\1[/youtube]',

		'[table]\\1[/table]', // tabela
		'[caption]\\1[/caption]', 
		'[tr]\\1[/tr]', 
		'[td]\\1[/td]',
		'[td=header]\\1[/td]',
